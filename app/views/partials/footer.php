<footer class="site-footer">
    ...
    <div class="site-footer__bottom">
        Copyright © 2026 Asociación Mexicana de Unidades de Verificación, Inspección y Estandarización AC. Todos los derechos reservados.
        <small>Diseñado por Diseño Web Jalisco</small>
    </div>
</footer>

<a class="back-to-top" href="#inicio" aria-label="Volver arriba">
